...
export const PARTIES: Party[] = [
  {
    ...
    beliefs: { economy: 65, welfare: 40, security: 70, environment: 45, foreign: 55 },
    orgStrength: 75,
    funding:      80,
  ...
  },
  {
    ...
    beliefs: { economy: 35, welfare: 75, security: 40, environment: 65, foreign: 70 },
    orgStrength: 65,
    funding:      55,
  ...
  },
  {
    ...
    beliefs: { economy: 70, welfare: 50, security: 55, environment: 60, foreign: 65 },
    orgStrength: 50,
    funding:      70,
  ...
  },
  {
    ...
    beliefs: { economy: 30, welfare: 65, security: 35, environment: 95, foreign: 75 },
    orgStrength: 35,
    funding:      30,
  ...
  },
  {
    ...
    beliefs: { economy: 55, welfare: 45, security: 85, environment: 25, foreign: 20 },
    orgStrength: 45,
    funding:      40,
